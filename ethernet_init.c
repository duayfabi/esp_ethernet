...
static const char *TAG = "ETHERNET_ETH_INIT";

#if CONFIG_ETHERNET_SPI_ETHERNETS_NUM
#define SPI_ETHERNETS_NUM           CONFIG_ETHERNET_SPI_ETHERNETS_NUM
#else
...
#define INIT_SPI_ETH_MODULE_CONFIG(eth_module_config, num)                                      \
    do {                                                                                        \
        eth_module_config[num].spi_cs_gpio = CONFIG_ETHERNET_ETH_SPI_CS ##num## _GPIO;           \
        eth_module_config[num].int_gpio = CONFIG_ETHERNET_ETH_SPI_INT ##num## _GPIO;             \
        eth_module_config[num].phy_reset_gpio = CONFIG_ETHERNET_ETH_SPI_PHY_RST ##num## _GPIO;   \
        eth_module_config[num].phy_addr = CONFIG_ETHERNET_ETH_SPI_PHY_ADDR ##num;                \
    } while(0)
...
static esp_eth_handle_t eth_init_internal(esp_eth_mac_t **mac_out, esp_eth_phy_t **phy_out)
{
    ...
    esp32_emac_config.smi_mdc_gpio_num = CONFIG_ETHERNET_ETH_MDC_GPIO;
    esp32_emac_config.smi_mdio_gpio_num = CONFIG_ETHERNET_ETH_MDIO_GPIO;
...
#elif CONFIG_ETHERNET_ETH_PHY_LAN87XX
    esp_eth_phy_t *phy = esp_eth_phy_new_lan87xx(&phy_config);
#elif CONFIG_ETHERNET_ETH_PHY_DP83848
    esp_eth_phy_t *phy = esp_eth_phy_new_dp83848(&phy_config);
#elif CONFIG_ETHERNET_ETH_PHY_KSZ80XX
...
#endif // CONFIG_ETHERNET_USE_INTERNAL_ETHERNET

#if CONFIG_ETHERNET_USE_SPI_ETHERNET
/**
...
static esp_err_t spi_bus_init(void)
{
    ...
    spi_bus_config_t buscfg = {
        .miso_io_num = CONFIG_ETHERNET_ETH_SPI_MISO_GPIO,
        .mosi_io_num = CONFIG_ETHERNET_ETH_SPI_MOSI_GPIO,
        .sclk_io_num = CONFIG_ETHERNET_ETH_SPI_SCLK_GPIO,
        .quadwp_io_num = -1,
        .quadhd_io_num = -1,
    };
    ESP_GOTO_ON_ERROR(spi_bus_initialize(CONFIG_ETHERNET_ETH_SPI_HOST, &buscfg, SPI_DMA_CH_AUTO),
                        err, TAG, "SPI host #%d init failed", CONFIG_ETHERNET_ETH_SPI_HOST);
...
static esp_eth_handle_t eth_init_spi(spi_eth_module_config_t *spi_eth_module_config, esp_eth_mac_t **mac_out, esp_eth_phy_t **phy_out)
{
    ...
    spi_device_interface_config_t spi_devcfg = {
        .mode = 0,
        .clock_speed_hz = CONFIG_ETHERNET_ETH_SPI_CLOCK_MHZ * 1000 * 1000,
        .queue_size = 20,
    ...
    eth_ksz8851snl_config_t ksz8851snl_config = ETH_KSZ8851SNL_DEFAULT_CONFIG(CONFIG_ETHERNET_ETH_SPI_HOST, &spi_devcfg);
    ...
    eth_dm9051_config_t dm9051_config = ETH_DM9051_DEFAULT_CONFIG(CONFIG_ETHERNET_ETH_SPI_HOST, &spi_devcfg);
    dm9051_config.int_gpio_num = spi_eth_module_config->int_gpio;
    esp_eth_mac_t *mac = esp_eth_mac_new_dm9051(&dm9051_config, &mac_config);
    esp_eth_phy_t *phy = esp_eth_phy_new_dm9051(&phy_config);
#elif CONFIG_ETHERNET_USE_W5500
    eth_w5500_config_t w5500_config = ETH_W5500_DEFAULT_CONFIG(CONFIG_ETHERNET_ETH_SPI_HOST, &spi_devcfg);
...
esp_err_t example_eth_init(esp_eth_handle_t *eth_handles_out[], uint8_t *eth_cnt_out)
{
...
#if CONFIG_ETHERNET_USE_INTERNAL_ETHERNET || CONFIG_ETHERNET_USE_SPI_ETHERNET
    ...
    spi_eth_module_config_t spi_eth_module_config[CONFIG_ETHERNET_SPI_ETHERNETS_NUM] = { 0 };
...
#if CONFIG_ETHERNET_SPI_ETHERNETS_NUM > 1
...
#endif // CONFIG_ETHERNET_USE_INTERNAL_ETHERNET || CONFIG_ETHERNET_USE_SPI_ETHERNET
